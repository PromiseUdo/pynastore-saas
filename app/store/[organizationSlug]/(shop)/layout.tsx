...
import { getDeliveryPromise, getFeaturedCategories, getStorePages } from '@/lib/storefront/catalog';
...
export default async function ShopLayout({
  ...
  const [navItems, departments, pages, delivery, checkout] = await Promise.all([
